                ...
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            ...
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2">Posted on January 1, 2021 by {{$posts->author}}</div>
                            <!-- Post categories-->
                            <a class="badge bg-secondary text-decoration-none link-light" href="#!">Web Design</a>
                            <a class="badge bg-secondary text-decoration-none link-light" href="#!">Freebies</a>
                        </header>
                        <!-- Preview image figure-->
                        <figure class="mb-4">{!! Html::image("/img/posts/". $posts->image, $posts->title, array('width'=>'900')) !!}</figure>
                        <!-- Post content-->
                        <section class="mb-5">
